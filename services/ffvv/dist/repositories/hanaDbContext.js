...
var _hanaDbConnection = _interopRequireDefault(require("./dbConnection/hanaDbConnection"));
...
class HanaDbContext {
  async GetOIDPeriodo(isoPais, codPais, campania) {
    ...
    let params = [isoPais, codPais, campania]; //let statement = `SELECT "_SYS_BIC"."belcorp.ods.corp.funciones::FIN_FN_OBTIE_OID_PERIO"('${isoPais}', '${codPais}', '${campania}') as OIDPERIODO FROM dummy`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetOIDPeriodo", statement, params, true);
  }
  ...
  async GetCampaniaActualRefac(codPais, codRegi, codZona, codRol) {
    ...
    */
    ...
    return _hanaDbConnection.default.execute("GetCampaniaActualRefac", statement, params);
  }
  ...
  async GetCampania(codPais, campania, periodos) {
    ...
    let statement = `SELECT "_SYS_BIC"."belcorp.ods.corp.funciones::OBTIE_CAMPA_SGTE_ANTER"(?, ?, ?) AS CAMPANIA FROM dummy`;
    let params = [codPais, campania, periodos]; //let statement = `SELECT "_SYS_BIC"."belcorp.ods.corp.funciones::OBTIE_CAMPA_SGTE_ANTER"('${codPais}', '${campania}', '${periodos}') AS CAMPANIA FROM dummy`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetCampania", statement, params);
  }
  ...
  async GetCantGananciaYSaldoRefac(codPais, campania, codRegi, codZona, codSecc) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_COUNTGANANCIAYSALDOREFAC"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetCantGananciaYSaldoRefac", statement, params);
  }
  ...
  async GetCantListActividadRefac(codPais, campania, codRegi, codZona, codSecc, facturacion) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_COUNTLISTADOACTIVIDAREFAC"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetCantListActividadRefac", statement, params);
  }
  ...
  async GetCantListCapitalizacionRefac(codPais, campania, codRegi, codZona, codSecc, tipo, facturacion) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, tipo, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_COUNTLISTADOCAPITALIZACIONREFAC"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${tipo}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetCantListCapitalizacionRefac", statement, params);
  }
  ...
  async GetCantListCicloNuevas(codPais, campania, codRegi, codZona, tipo) {
    ...
    let params = [codPais, campania, codRegi, codZona, tipo]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_COUNTLISTADOCICLONUEVAS"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${tipo}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetCantListCicloNuevas", statement, params);
  }
  ...
  async GetCantListPedido(codPais, campania, codZona, tipo, codRegi, facturacion) {
    ...
    let params = [codPais, campania, codZona, tipo, codRegi, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_COUNTLISTADOPEDIDO"('${codPais}', '${campania}', '${codZona}', '${tipo}', '${codRegi}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetCantListPedido", statement, params);
  }
  ...
  async GetCantListPedidosVentaRefac(codPais, campania, codRegi, codZona, codSecc, tipo, facturacion) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, tipo, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_COUNTLISTADOPEDIDOSVENTAREFAC"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${tipo}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetCantListPedidosVentaRefac", statement, params);
  }
  ...
  async GetCantListPosiblesConsecutivasRefac(codPais, campania, codRegi, codZona, codSecc) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_COUNTLISTADOPOSIBLESCONSECUTIVASREFAC"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetCantListPosiblesConsecutivasRefac", statement, params);
  }
  ...
  async GetCantListVentaNeta(codPais, campania, codRegi, codZona, tipo, facturacion) {
    ...
    let params = [codPais, campania, codRegi, codZona, tipo, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_COUNTLISTADOVENTANETA"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${tipo}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetCantListVentaNeta", statement, params);
  }
  ...
  async GetCantSaldoPendienteRefac(codPais, campania, codRegi, codZona, codSecc) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_COUNTSALDOPENDIENTEREFAC"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetCantSaldoPendienteRefac", statement, params);
  }
  ...
  async GetCountListPegRefac(codPais, campania, codRegi, codZona, facturacion) {
    ...
    let params = [codPais, campania, codRegi, codZona, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_COUNTLISTADOPEGREFAC"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetCountListPegRefac", statement, params);
  }
  ...
  async GetEstadoConsultora(codPais) {
    ...
    let params = [];
    return _hanaDbConnection.default.execute("GetEstadoConsultora", statement, params);
  }
  ...
  async GetGananciaSaldoRefac(codPais, campania, codRegi, codZona, codSecc) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIE_GANANCIA_SALDO_REFAC"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetGananciaSaldoRefac", statement, params);
  }
  ...
  async GetIndicadorActividad(codPais, campania, codRegi, codZona, codSecc, tipo) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, tipo]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIE_INDICADOR_ACTIVIDAD"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${tipo}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetIndicadorActividad", statement, params);
  }
  ...
  async GetIndicadorCapitalizacion(codPais, campania, codRegi, codZona, codSecc, tipo) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, tipo]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIE_INDICADOR_CAPITALIZACION"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${tipo}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetIndicadorCapitalizacion", statement, params);
  }
  ...
  async GetIndicadorCicloNuevas(codPais, campania, codRegi, codZona, codSecc, tipo) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, tipo]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIE_INDICADOR_CICLO_NUEVAS"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${tipo}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetIndicadorCicloNuevas", statement, params);
  }
  ...
  async GetIndicadorPedidos(codPais, campania, codRegi, codZona, codSecc) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIE_INDICADOR_PEDIDOS"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetIndicadorPedidos", statement, params);
  }
  ...
  async GetIndicadorPosibleConsecu(codPais, campania, codRegi, codZona, codSecc, tipo) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, tipo]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIE_INDICADOR_POSIBLE_CONSECU"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${tipo}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetIndicadorPosibleConsecu", statement, params);
  }
  ...
  async GetIndicadorPosiblesEgresos(codPais, campania, codRegi, codZona, codSecc, tipo) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, tipo]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIE_INDICADOR_PEG" ('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${tipo}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetIndicadorPosiblesEgresos", statement, params);
  }
  ...
  async GetIndicadorVentas(codPais, campania, codRegi, codZona, codSecc, tipo) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, tipo]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIE_INDICADOR_VENTAS"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${tipo}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetIndicadorVentas", statement, params);
  }
  ...
  async GetListActividadDev(codPais, campania, codRegi, codZona, codSecc, facturacion) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_LISTADOACTIVIDAD_dev"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetListActividadDev", statement, params);
  }
  ...
  async GetListActividad(codPais, campania, codRegi, codZona, codSecc, facturacion) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_LISTADOACTIVIDAD"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetListActividad", statement, params);
  }
  ...
  async GetListCapitalizacionRefac(codPais, campania, codRegi, codZona, codSecc, tipo, facturacion) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, tipo, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_LISTADOCAPITALIZACIONREFAC"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${tipo}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetListCapitalizacionRefac", statement, params);
  }
  ...
  async GetListCicloNuevasAll(codPais, campania, codZona, codSecc, tipo, indConsul) {
    ...
    let params = [codPais, campania, codZona, codSecc, tipo, indConsul]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_LISTADOCICLONUEVASALL"('${codPais}', '${campania}', '${codZona}', '${codSecc}', '${tipo}', '${indConsul}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetListCicloNuevasAll", statement, params);
  }
  ...
  async GetListCicloNuevas(codPais, campania, codZona, codSecc, tipo) {
    ...
    let params = [codPais, campania, codZona, codSecc, tipo]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_LISTADOCICLONUEVAS"('${codPais}', '${campania}', '${codZona}', '${codSecc}', '${tipo}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetListCicloNuevas", statement, params);
  }
  ...
  async GetListGananciaYSaldo(codPais, campania, codRegi, codZona, codSecc) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_LISTADOGANANCIAYSALDO"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetListGananciaYSaldo", statement, params);
  }
  ...
  async GetListPedidosVentaRefac(codPais, campania, codRegi, codZona, codSecc, tipo, ordenamiento, facturacion) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, tipo, ordenamiento, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_LISTADOPEDIDOSVENTAREFAC"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${tipo}', '${ordenamiento}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetListPedidosVentaRefac", statement, params);
  }
  ...
  async GetListPegRefac(codPais, campania, codRegi, codZona, codSecc, esPEGCx, facturacion) {
    ...
    */
    ...
    return _hanaDbConnection.default.execute("GetListPegRefac", statement, params);
  }
  ...
  async GetListPosiblesConsecutivasRefac(codPais, campania, codRegi, codZona, codSecc, ordenamiento) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc, ordenamiento]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_LISTADOPOSIBLESCONSECUTIVASREFAC"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}', '${ordenamiento}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetListPosiblesConsecutivasRefac", statement, params);
  }
  ...
  async GetListSaldoPendiente(codPais, campania, codRegi, codZona, codSecc) {
    ...
    let params = [codPais, campania, codRegi, codZona, codSecc]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_LISTADOSALDOPENDIENTE"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${codSecc}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetListSaldoPendiente", statement, params);
  }

  async GetListVentaNetaCube(campaniaCX3, campaniaCX2, campaniaCX5, campaniaCX4, campaniaCX1, tipoSol, campaniaCX, tipo, campaniaCX6, codPais, tipoClasif, campania, codZona, montoMin, codSecc, numCampanias) {
    /*
    ...
    */
    ...
    return _hanaDbConnection.default.execute("GetListVentaNetaCube", statement, params);
  }
  ...
  async GetPais(codPais) {
    ...
    let params = [codPais]; //let statement = `SELECT "_SYS_BIC"."belcorp.ods.corp.funciones::CCC_FN_OBTIE_PARAM_GENER"('${codPais}', 'CodigoPais') as CODIGOPAIS FROM dummy`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetPais", statement, params);
  }
  ...
  async GetPeriodoSiguiente(codPais, codigoPais, campania, type) {
    ...
    let params = [codPais, codigoPais, campania, type]; //let statement = `SELECT "_SYS_BIC"."belcorp.ods.corp.funciones::GEN_FN_PERIO_NSIGU"('${codPais}', '${codigoPais}', '${campania}', '${type}') as CAMPANIA FROM dummy`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetPeriodoSiguiente", statement, params);
  }
  ...
  async GetMontoMinimo(codPais) {
    ...
    let params = [codPais]; //let statement = `SELECT ifnull(max(val_mont_mini), 0) as MONTOMINIMO FROM sicc_corp.lec_progr_nivel_rango WHERE isopais = '${codPais}'`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetMontoMinimo", statement, params);
  }
  ...
  async GetTipoSolicitud(codPais) {
    ...
    let params = [codPais]; //let statement = `SELECT tsp.oid_tipo_soli_pais as TIPOSOLICITUD from sicc_corp.ped_tipo_solic_pais tsp, sicc_corp.ped_tipo_solic ts where tsp.tsol_oid_tipo_soli = ts.oid_tipo_soli and tsp.isopais = ts.isopais and tsp.isopais = '${codPais}' and cod_tipo_soli= 'SOC'`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetTipoSolicitud", statement, params);
  }
  ...
  async GetTipoClasificacion(codPais, codigoPais) {
    ...
    let params = [codPais, codigoPais]; //let statement = `SELECT ifnull(to_number(x.val_pain), 0) as TIPOCLASIFICACION FROM sicc_corp.bas_param_inter x WHERE x.sist_cod_sist like '%IVR%' and x.isopais = '${codPais}' and x.pais_cod_pais = '${codigoPais}' and x.sist_cod_sist = 'IVR' and x.inte_cod_inte = 'IVR-41' and x.nom_pain = 'tipoClasificacionTop'`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetTipoClasificacion", statement, params);
  }
  ...
  async GetNumeroCampanias(codPais, codigoPais) {
    ...
    let params = [codPais, codigoPais]; //let statement = `SELECT "_SYS_BIC"."belcorp.ods.corp.funciones::GEN_FN_PARAM_PAIS"('${codPais}', '${codigoPais}', 'GEN', '000') as NUMEROCAMPANIAS FROM dummy`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetNumeroCampanias", statement, params);
  }
  ...
  async GetListVentaNeta(codPais, campania, codZona, codSecc, tipo, facturacion) {
    ...
    let params = [codPais, campania, codZona, codSecc, tipo, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_LISTADOVENTANETA"('${codPais}', '${campania}', '${codZona}', '${codSecc}', '${tipo}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetListVentaNeta", statement, params);
  }
  ...
  async GetListVentaNetaTest(codPais, campania, codZona, codSecc, tipo) {
    ...
    let params = [codPais, campania, codZona, codSecc, tipo]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTENER_LISTADOVENTANETA_dev1" ('${codPais}', '${campania}', '${codZona}', '${codSecc}', '${tipo}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetListVentaNetaTest", statement, params);
  }
  ...
  async GetRegionZonaSeccionActividad(codPais, campania, codRegi, codZona, tipo) {
    ...
    let params = [codPais, campania, codRegi, codZona, tipo]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIENE_REGIONZONASECCIONACTIVIDAD"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${tipo}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetRegionZonaSeccionActividad", statement, params);
  }
  ...
  async GetRegionZonaSeccionCapitalizacion(codPais, campania, codRegi, codZona, tipo) {
    ...
    let params = [codPais, campania, codRegi, codZona, tipo]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIENE_REGIONZONASECCIONCAPITALIZACION"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${tipo}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetRegionZonaSeccionCapitalizacion", statement, params);
  }
  ...
  async GetRegionZonaSeccionCicloNuevas(codPais, campania, codRegi, codZona, facturacion) {
    ...
    let params = [codPais, campania, codRegi, codZona, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIENE_REGIONZONASECCIONCICLONUEVAS"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetRegionZonaSeccionCicloNuevas", statement, params);
  }
  ...
  async GetRegionZonaSeccionCobranza(codPais, campania, codRegi, codZona) {
    ...
    let params = [codPais, campania, codRegi, codZona]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIENE_REGIONZONASECCIONCOBRANZA"('${codPais}', '${campania}', '${codRegi}', '${codZona}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetRegionZonaSeccionCobranza", statement, params);
  }
  ...
  async GetRegionZonaSeccionPedido(codPais, campania, codRegi, codZona, tipo) {
    ...
    let params = [codPais, campania, codRegi, codZona, tipo]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIENE_REGIONZONASECCIONPEDIDO"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${tipo}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetRegionZonaSeccionPedido", statement, params);
  }
  ...
  async GetRegionZonaSeccionPosiblesConsecutivas(codPais, campania, codRegi, codZona, facturacion) {
    ...
    let params = [codPais, campania, codRegi, codZona, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIENE_REGIONZONASECCIONPOSIBLESCONSECUTIVAS"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetRegionZonaSeccionPosiblesConsecutivas", statement, params);
  }
  ...
  async GetRegionZonaSeccionVenta(codPais, campania, codRegi, codZona, facturacion) {
    ...
    let params = [codPais, campania, codRegi, codZona, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIENE_REGIONZONASECCIONVENTA"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetRegionZonaSeccionVenta", statement, params);
  }
  ...
  async GetRegiZonaSeccPeg(codPais, campania, codRegi, codZona, facturacion) {
    ...
    let params = [codPais, campania, codRegi, codZona, facturacion]; //let statement = `CALL "SICC_CORP"."belcorp.ods.corp.modelos::SP_OBTIENE_REGIONZONASECCIONPEG"('${codPais}', '${campania}', '${codRegi}', '${codZona}', '${facturacion}')`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetRegiZonaSeccPeg", statement, params);
  }
  ...
  async GetSaldoPendiente(codPais, codRegi, codZona, codSecc, campania, tipo) {
    ...
    let params = [codPais, codRegi, codZona, codSecc, campania, tipo]; //let statement = `SELECT "_SYS_BIC"."belcorp.ods.corp.funciones::OBTIE_INDICADOR_SALDO_PDTE"('${codPais}', '${codRegi}', '${codZona}', '${codSecc}', '${campania}', '${tipo}') AS TOTALPENDIENTE FROM dummy`;
    //let params = [];

    return _hanaDbConnection.default.execute("GetSaldoPendiente", statement, params);
  }
  ...
  async GetSeccionZona(codPais, codRegi, codZona) {
    ...
    let statement = `SELECT ZONAID, CODIGO, DESCRIPCION, SOCIAEMPRESARIA
      ...
      PLACEHOLDER = ('$$p_codpais$$', '${codPais}'),
      PLACEHOLDER = ('$$p_codzona$$', '${codZona}'))`;
    let params = []; //let params = [codRegi, codPais, codZona];

    return _hanaDbConnection.default.execute("GetSeccionZona", statement, params);
  }
  ...
  async GetZonaRegion(codPais, codRegi) {
    ...
    let statement = `SELECT ZONAID, CODIGO, DESCRIPCION, GERENTEZONA, GZEMAIL
      ...
      (PLACEHOLDER = ('$$p_codregi$$', '${codRegi}'),
      PLACEHOLDER = ('$$p_codpais$$', '${codPais}'))`;
    let params = []; //let params = [codRegi, codPais];

    return _hanaDbConnection.default.execute("GetZonaRegion", statement, params);
  }
  ...
  async ValidateZonaRegion(codPais, codRegi, codZona) {
    ...
    return _hanaDbConnection.default.execute("ValidateZonaRegion", statement, params);
  }
  ...
  async GetCantListActividadRefacStatement(codPais, campania, codRegi, codZona, codSecc, facturacion) {
    ...
    */
    ...
    return _hanaDbConnection.default.execute("GetCantListActividadRefacStatement", statement, params);
  }

}

exports.default = HanaDbContext;