...
router.get(
  "/ObtenerCantListPedidosVentaRefac/:codPais/:campania/:tipo/:facturacion/:codRegi?/:codZona?/:codSecc?",
  home.GetCantListPedidosVentaRefac
);

router.get("/ObtenerCountListPegRefac/:codPais/:campania/:facturacion/:codRegi?/:codZona?", home.GetCountListPegRefac);

router.get(
  "/ObtenerCantListPosiblesConsecutivasRefac/:codPais/:campania/:codRegi?/:codZona?/:codSecc?",
  home.GetCantListPosiblesConsecutivasRefac
);
...
router.get(
  "/ObtenerCantListCapitalizacionRefac/:codPais/:campania/:tipo/:facturacion/:codRegi?/:codZona?/:codSecc?",
  home.GetCantListCapitalizacionRefac
);
...
router.get(
  "/ObtenerListCapitalizacionRefac/:codPais/:campania/:tipo/:facturacion/:codRegi?/:codZona?/:codSecc?",
  home.GetListCapitalizacionRefac
);
...
router.get(
  "/ObtenerListPedidosVentaRefac/:codPais/:campania/:tipo/:ordenamiento/:facturacion/:codRegi?/:codZona?/:codSecc?",
  home.GetListPedidosVentaRefac
);

router.get("/ObtenerListPegRefac/:codPais/:campania/:esPEGCx/:facturacion/:codRegi?/:codZona?/:codSecc?", home.GetListPegRefac);

router.get(
  "/ObtenerListPosiblesConsecutivasRefac/:codPais/:campania/:ordenamiento/:codRegi?/:codZona?/:codSecc?",
  home.GetListPosiblesConsecutivasRefac
);
...
router.get(
  "/ObtenerRegionZonaSeccionCicloNuevas/:codPais/:campania/:facturacion/:codRegi?/:codZona?",
  home.GetRegionZonaSeccionCicloNuevas
);
...
router.get(
  "/ObtenerRegionZonaSeccionPosiblesConsecutivas/:codPais/:campania/:facturacion/:codRegi?/:codZona?",
  home.GetRegionZonaSeccionPosiblesConsecutivas
);
